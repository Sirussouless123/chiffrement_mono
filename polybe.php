  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarColor01">
      <ul class="navbar-nav me-auto">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="polybe.php">Chiffrement de Polybe
            ...
            <div class="container-login100">
                <div class="wrap-login100">
                    <form class="login100-form validate-form p-l-55 p-r-55 p-t-178" method="GET">
                        ...
                        <div class="wrap-input100 validate-input" data-validate="Entrez une clé">
                            <input class="input100" type="text" name="cle" placeholder="Valeur de la clé">
                            <span class="focus-input100"></span>
                        </div>
                        ...
                        ?>
                            <div class="text-center mt-3 p-5 mb-5 bg-primary rounded-pill">
                                <h3 class="text-success">Résultat</h3>
                                <p class="pt-1  text-center text-white"><?= chiffrementPolybe($_GET['mes'],$_GET['cle']) ?></p>
                            </div>
                        <?php
                        }
                        ?>
                        ...
                        ?>
                            <div class="text-center mt-3 p-2 mb-5 bg-primary rounded-pill">
                                <h3 class="text-success">Résultat</h3>
                                <p class="pt-1  text-center text-white"><?= dechiffrementPolybe($_GET['mes'],$_GET['cle']) ?></p>
                            </div>
                        <?php
                        }
                        ?>
