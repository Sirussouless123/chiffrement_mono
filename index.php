...
<head>
    ...
    <title>Chiffrement|Dechiffrement</title>
    ...
    <header>
        <nav class="navbar navbar-expand-lg bg-primary" data-bs-theme="dark">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">Chiffrement</a>
                ...
                <div class="collapse navbar-collapse" id="navbarColor01">
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item">
                            <a class="nav-link active" href="index.php">Chiffrement de César
                                <span class="visually-hidden">(current)</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="polybe.php">Chiffrement de Polybe</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="affine.php">Chiffrement affine</a>
                        </li>
            ...
            <div class="container-login100">
                <div class="wrap-login100">
                    <form class="login100-form validate-form p-l-55 p-r-55 p-t-178" method="GET">
                        ...
                        <div class="wrap-input100 validate-input" data-validate="Entrez le décalage">
                            <input class="input100" type="number" name="dec" placeholder="Décalage">
                            <span class="focus-input100"></span>
                        </div>
                        ...
                        ?>
                            <div class="text-center mt-3 p-2 mb-5 bg-primary rounded-pill">
                                ...
                                <p class="pt-1  text-center text-white"><?= chiffrement($_GET['mes'], $_GET['dec']) ?></p>
                            </div>
                        <?php
                        }
                        ?>
                        ...
                        ?>
                            <div class="text-center mt-3 p-2 mb-5 bg-primary rounded-pill">
                                <h3 class="text-success">Résultat</h3>
                                <p class="pt-1  text-center text-white"><?= dechiffrement($_GET['mes'], $_GET['dec']) ?></p>
                            </div>
                        <?php
                        }
                        ?>
